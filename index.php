        ...
        <?php foreach($post->getPost() as $post) { ?>
            <div class="media">
                <div class="media-left media-top">
                    <img src="images/<?php echo $post['image']; ?>" class="media-object" style="width:200px; height: 200px; margin: 50px;"/>
                    <p>
            ...
            <div class="col-md-8">
            	...
            	foreach($tags->getAllTags() as $tag){?>
                    ...
                    <button type="button" class="btn btn-outline-warning"><?php  echo $tag['tag'];?>
            		</button></a>
